...
int NOMBRE_DES_LIGNES(char nom_fichier[15]){           //fonction qui retourne le nombre des lignes d'un fichier
    FILE *fichier;
    char ch[256];
    int i=0;
...
int AJOUTER(produit * tab,int  n){        // n=taille du tableau
...
while(atoi(choix)!=9){                      //atoi() converts a string into an integer
